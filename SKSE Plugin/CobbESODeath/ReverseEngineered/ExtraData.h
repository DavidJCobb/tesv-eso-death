...
namespace RE {
   ...
   class ExtraDismemberedLimbs : public BSExtraData {
      public:
         ...
         bool   fedOnByWerewolf; // 0A // HasBeenEaten checks this. WerewolfFeedEffect sets it; maybe cannibalism does, too?
         UInt8  pad0B;
         SInt32 unk0C = -1; // 0C
   ...
   class BaseExtraList {
      public:
         ...
         DEFINE_MEMBER_FN(GetExtraData,     void*,    0x0040A8A0, UInt32 type);               // Returns the specified extra-data object (analogous to SKSE's GetByType).
         ...
         DEFINE_MEMBER_FN(GetExtraCellAcousticSpace,        void*,   0x0040CDB0); // Return type not verified.
         DEFINE_MEMBER_FN(GetExtraCellImageSpace,           void*,   0x0040CDE0); // Return type not verified.
         DEFINE_MEMBER_FN(GetExtraCellMusicType,            void*,   0x0040CDA0); // Return type not verified.
         ...
         DEFINE_MEMBER_FN(GetExtraEncounterZone,            void*,   0x0040D9F0);
