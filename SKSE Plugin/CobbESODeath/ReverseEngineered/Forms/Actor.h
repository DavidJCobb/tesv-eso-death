...
namespace RE {
   ...
   class Actor : public TESObjectREFR {
      ...
      public:
         ...
         virtual float Unk_127(UInt32 avIndex, float avValueMod); // 127 // OnActorValueChange?
         ...
         enum Flags2 : UInt32 {
            ...
            kFlags_Flag2_00080000         = 0x00080000,
         ...
         UInt32   unk0D4; // D4
         Struct007AF7A0* unk0D8; // D8 // Unk_D3 accesses this pointer
         ...
         struct ActorValueState { // sizeof == 0xC
            ...
            enum {
               ...
               //
               kIndex_Buff = 0, // Used if the AV has been buffed  above its maximum. floats[0] == current value - base value
               kIndex_Unk  = 1, // floats[1] may actually be a UInt32 specifying which index to use?? why did Beth store it this way?
               kIndex_Nerf = 2, // Used if the AV has been damaged below its maximum. floats[2] == current value - base value
            };
            float floats[3]; // 00
            //
         ...
         struct Struct006F2190 { // sizeof == 0x10
            ...
            ActorValueState* unk0C = nullptr; // 0C // array // IronSightsState*?
            //
            ...
            //
            ActorValueState* Pseudocode006F22D0(UInt32 actorValueIndex) const {
            ...
            bool Pseudocode006F2870(UInt32 actorValueIndex, float* out) const {
               //
         ...
         DEFINE_MEMBER_FN(GetActorValueRegenDelay, float,       0x006DEB40, UInt32 avIndex);
