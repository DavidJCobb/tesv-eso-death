...
namespace RE {
   class ActorValueInfo : public TESForm {
      public:
         ...
         enum {
            ...
            kAVFlag_Unk008000 = 0x008000, // DetectLifeRange, DiseaseResist, ElectricResist, Fame, FireResist, FrostResist, IgnoreCrippledLimbs, Infamy, Invisibility, JumpingBonus, MagicResist, NightEye, Paralysis, PoisonResist, Telekinesis, WardDeflection, WardPower, WaterBreathing, WaterWalking, 
            kAVFlag_Unk020000 = 0x020000, // PerceptionCondition, 
            kAVFlag_Unk040000 = 0x040000, // every skill, Aggression, Assistance, CarryWeight, HealRate, Health, Invisibility, Magicka, MagickaRate, Morality, Paralysis, SpeedMult, Stamina, StaminaRate, VoicePoints, VoiceRate, WardDeflection, WardPower, // see 006DF98C
            kAVFlag_Unk080000 = 0x080000, // every skill, Health, Magicka, OneHanded, Stamina, VoicePoints, // see 006DF9A9
            kAVFlag_DoNotReduceInGodMode = 0x100000, // see PlayerCharacter::Unk_127
         };
         enum AVType : UInt32 {
   ...
   typedef void(*ActorValueChangeHandler)(Actor*, UInt32 avIndex, float, float, UInt32 unk);
